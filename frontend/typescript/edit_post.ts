  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (btnSavePost) {
      btnSavePost.addEventListener("click", function (event) {
        ...
        var newTitle = (document.getElementById("title") as HTMLInputElement).value;
        var newBody = (document.getElementById("body") as HTMLInputElement).value;
        var newImage = (document.getElementById("image") as HTMLInputElement).files[0];
